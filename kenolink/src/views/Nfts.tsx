import { VStack, Heading, FormControl, FormLabel, Button, Box, Select } from '@chakra-ui/react';
...
export const Nfts = () => {
  ...
  const onChangeHandler = (event: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    for (let i = 0; i < selectedOptions.length; i++) {
      newNumbers.push(selectedOptions[i].value);
    }
